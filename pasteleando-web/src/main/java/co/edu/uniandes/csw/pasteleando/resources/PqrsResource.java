 ...
 * "/api" y este recurso tiene la ruta "pqrs".</i>
 * <h2>Anotaciones </h2>
 * <pre>
...
public class PqrsResource {
     ...
     * @return JSON {@link PqrsDTO} - La entidad de pqrs guardada con el
     ...
     * </pre>
     *
     * @return JSONArray {@link PqrsDTO} - Las entidades de pqrs encontradas en
     ...
     * </pre>
     *
     * @param id Identificador de la entidad de pqrs que se esta buscando. Este
    ...
    /**
     * <h1>PUT /api/pqrs/{id} : Actualizar una entidad de pqrs con el id
     * dado.</h1>
     * <pre>Cuerpo de petición: JSON {@link PqrsDTO}.
     *
     ...
     * </pre>
     *
     * @param id Identificador de la entidad de pqrs que se desea
     ...
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera al no poder actualizar la entidad de pqrs
     ...
     * </pre>
     *
     * @param id Identificador de la entidad de pqrs que se desea borrar. Este
     * debe ser una cadena de dígitos.
     */
    @DELETE
    @Path("{id: \\d+}")
