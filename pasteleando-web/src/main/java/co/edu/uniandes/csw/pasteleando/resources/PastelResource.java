 ...
 * "/api" y este recurso tiene la ruta "pasteles".</i>
 *
 * <h2> Anotaciones </h2>
 * <pre>
...
public class PastelResource {
     ...
     * @return JSON {@link PastelDetailDTO} - el pastel guardado con el
     * atributo.
     * @throws BusinessLogicException {@link BusinessLogicException} - Error de
     * lógica que se genera cuando ya existe la ciudad.
     */
    @Path("pasteles")
    @POST
    @Produces("application/json")
     ...
     * </pre>
     *
     * @param id Identificador del la pastel que se esta buscando. Este debe ser
     ...
     * </pre>
     *
     * @return JSONArray {@link PastelDetailDTO} - Los pasteles encontrados en
     ...
     * </pre>
     *
     * @param id Identificador del pasteld que se desea actualizar.Este debe ser
     * una cadena de dígitos.
     * @param pastel {@link PastelDetailDTO} el pastel que se desea guardar.
     ...
     * </pre>
     *
     * @param id Identificador del pastel que se desea borrar. Este debe ser una
     * cadena de dígitos.
     */
    @DELETE
    @Path("{id: \\d+}")
