 ...
 * "/api" y este recurso tiene la ruta "pedido".</i>
 * <h2>Anotaciones </h2>
 * <pre>
...
public class PedidoResource {
     ...
     * </pre>
     *
     * @param pPedido {@link PedidoDTO} - La entidad de pedido que se desea
     * guardar.
     * @return JSON {@link PedidoDTO} - La entidad de pedido guardada con el
     ...
     * </pre>
     *
     * @return JSONArray {@link PedidoDTO} - Las entidades de pedido encontradas
     ...
     * </pre>
     *
     * @param id Identificador de la entidad de pedido que se esta buscando.
    ...
    /**
     * <h1>PUT /api/pedido/{id} : Actualizar una entidad de pedido con el id
     * dado.</h1>
     * <pre>Cuerpo de petición: JSON {@link PedidoDTO}.
     *
     ...
     * </pre>
     *
     * @param id Identificador de la entidad de pedido que se desea
     * actualizar.Este debe ser una cadena de dígitos.
     * @param detailDTO {@link PedidoDTO} La entidad de pedido que se desea
     * guardar.
     * @return JSON {@link PedidoDTO} - La entidad de pedido guardada.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera al no poder actualizar la entidad de pedido
     ...
     * </pre>
     *
     * @param id Identificador de la entidad de pedido que se desea borrar. Este
