 ...
 * "/api" y este recurso tiene la ruta "carritos".</i>
 *
 * <h2> Anotaciones </h2>
 * <pre>
...
public class CarritoResource {
     ...
     * </pre>
     *
     * @param carrito {@link CarritoDetailDTO} - el carrito que se desea
     * guardar.
     * @return JSON {@link CarritoDetailDTO} - el carrito guardado con el
     ...
     * </pre>
     *
     * @return JSONArray {@link CarritoDetailDTO} - Los carritos encontradas en
     ...
     * </pre>
     *
     * @param id Identificador del carrito que se desea actualizar.Este debe ser
     * una cadena de dígitos.
     ...
     * </pre>
     *
     * @param id Identificador del carrito que se desea borrar. Este debe ser
     * una cadena de dígitos.
     */
    @DELETE
    @Path("{id: \\d+}")
